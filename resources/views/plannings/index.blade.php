                    ...
                    <form action="{{ route('plannings.destroy', $planning->id) }}" method="POST">
                        ...
                        @can('inspection-delete')
                            <button type="submit" class="btn btn-danger"
                                onclick="return confirm('Are you sure you want to delete: {{ $planning->name }}?')">Delete</button>
                        @endcan
                        <a href="{{ route('plannings.sub.index', $planning->id) }}" class="btn btn-primary"
                            style="background-color: orange">Schedule</a>
                    </form>
                </td>
            </tr>
        @endforeach
